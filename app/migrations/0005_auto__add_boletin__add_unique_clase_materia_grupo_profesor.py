...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_boletin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.AUser'])),
        ...
        db.send_create_signal(u'app', ['Boletin'])

        # Adding unique constraint on 'Clase', fields ['materia', 'grupo', 'profesor']
        db.create_unique(u'app_clase', ['materia_id', 'grupo_id', 'profesor_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Clase', fields ['materia', 'grupo', 'profesor']
        db.delete_unique(u'app_clase', ['materia_id', 'grupo_id', 'profesor_id'])

        # Deleting model 'Boletin'
        db.delete_table(u'app_boletin')
