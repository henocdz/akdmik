...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Materia', fields ['nombre']
        db.create_unique(u'app_materia', ['nombre'])

        # Adding unique constraint on 'Materia', fields ['keyname']
        db.create_unique(u'app_materia', ['keyname'])

        # Adding unique constraint on 'Grupo', fields ['nombre']
        db.create_unique(u'app_grupo', ['nombre'])

        # Adding unique constraint on 'Grupo', fields ['salon']
        db.create_unique(u'app_grupo', ['salon'])


    def backwards(self, orm):
        # Removing unique constraint on 'Grupo', fields ['salon']
        db.delete_unique(u'app_grupo', ['salon'])

        # Removing unique constraint on 'Grupo', fields ['nombre']
        db.delete_unique(u'app_grupo', ['nombre'])

        # Removing unique constraint on 'Materia', fields ['keyname']
        db.delete_unique(u'app_materia', ['keyname'])

        # Removing unique constraint on 'Materia', fields ['nombre']
        db.delete_unique(u'app_materia', ['nombre'])
