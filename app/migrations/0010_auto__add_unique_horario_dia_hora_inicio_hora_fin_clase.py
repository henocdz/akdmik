...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Horario', fields ['dia', 'hora_inicio', 'hora_fin', 'clase']
        db.create_unique(u'app_horario', ['dia', 'hora_inicio', 'hora_fin', 'clase_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Horario', fields ['dia', 'hora_inicio', 'hora_fin', 'clase']
        db.delete_unique(u'app_horario', ['dia', 'hora_inicio', 'hora_fin', 'clase_id'])
    ...
    models = {
        ...
        u'app.horario': {
            'Meta': {'unique_together': "(('dia', 'hora_inicio', 'hora_fin', 'clase'),)", 'object_name': 'Horario'},
            'clase': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Clase']"}),
